...
const News = (props) => {
  ...
  const updateNews = async () => {
    ...
    const url = `https://newsapi.org/v2/top-headlines?country=${props.country}&category=${props.category}&apiKey=529beab108264e419985c1fee2123212&page=${page}&pageSize=${props.pageSize}`;
    setLoading(true);
